...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.CheckConstraint(condition=models.Q(('kanal__isnull', True), models.Q(('kanal', 'VET'), _negated=True), ('satici_veteriner__isnull', False), _connector='OR'), name='etiket_vet_icin_veteriner_zorunlu'), models.CheckConstraint(condition=models.Q(('kanal__isnull', True), models.Q(('kanal', 'SHOP'), _negated=True), ('satici_petshop__isnull', False), _connector='OR'), name='etiket_shop_icin_petshop_zorunlu'), models.CheckConstraint(condition=models.Q(('kanal__isnull', True), models.Q(('kanal', 'ONLINE'), _negated=True), models.Q(('satici_veteriner__isnull', True), ('satici_petshop__isnull', True)), _connector='OR'), name='etiket_online_icin_partner_bos')],
            },
        ),
    ]
